...
| AP4 | Return the same resource for a retried mutation request | `PK=TENANT#<tenantId>`, `SK=IDEMPOTENCY#<operation>#<keyHash>` |
...
| AP11 | List one saved route's risk observations | `PK=USER#<userId>`, `SK begins_with ROUTE_RISK#<savedItemId>#` |
...
{
  "PK": "TENANT#9b9a...",
  "SK": "IDEMPOTENCY#saved-route:create#5d41402abc4b2a76b9719d911017c592",
  "entityType": "IdempotencyRecord",
  "tenantId": "9b9a...",
  "operation": "saved-route:create",
  "keyHash": "5d41402abc4b2a76b9719d911017c592...",
  "resourceId": "8c0d...",
  "createdAt": "2026-07-07T02:30:00Z",
  "expiresAt": 1783477800
}
```
