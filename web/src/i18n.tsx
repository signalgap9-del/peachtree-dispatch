...
export const copy = {
  en: {
    ...
    "dashboard.subtitle": "Live weather samples and active travel hazards",
    ...
    "saved.signInDetail": "Saved places are private and stored per user. Public visitors do not receive fabricated sample records.",
    ...
    "data.unavailableDetail": "Unavailable values are hidden; no demo data is being substituted.",
  },
  ko: {
    "nav.home": "홈",
    "nav.map": "지도",
    ...
    "header.googleUnavailable": "Google 회원가입 흐름은 연결됐지만, 이 배포에는 아직 OAuth 시크릿이 설정되지 않았습니다.",
    "header.authUnavailable": "배포된 프리뷰에서 로그인할 수 있습니다.",
    "language.label": "언어",
    "language.en": "EN",
    "language.ko": "KR",
    "toast.loginFailed": "로그인을 완료하지 못했습니다.",
    "notFound.title": "아직 이 경로는 지도에 없습니다.",
    "notFound.detail": "홈으로 돌아가거나 전국 리스크 지도를 열어보세요.",
    "notFound.home": "홈으로",
    "notFound.map": "지도 열기",
    ...
    "dashboard.subtitle": "실시간 날씨 샘플과 이동 위험 경보",
    ...
    "saved.signInDetail": "저장 장소는 사용자별 비공개 데이터입니다. 공개 방문자에게 가짜 샘플 기록을 보여주지 않습니다.",
    ...
    "data.unavailableDetail": "사용 불가 값은 숨기며, 데모 데이터를 대신 넣지 않습니다.",
  },
} as const;
